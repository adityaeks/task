        ...
        <div class="bg-white dark:bg-zinc-900 rounded-3xl border border-slate-200/60 dark:border-zinc-800/60 shadow-sm overflow-hidden">
            ...
            <div class="p-6">
                ...
                <p id="empty-detail-note" class="text-center text-xs text-slate-400 dark:text-zinc-500 py-6 hidden">
                    Klik "Tambah Baris" untuk menambah sub-tugas.
                </p>
            </div>
        </div>
...
<script>
    ...
    function addDetailRow(data = {}) {
        ...
        document.getElementById('empty-detail-note').classList.add('hidden');
            ...
            <div class="grid grid-cols-12 gap-3 items-center">
                <div class="col-span-12 md:col-span-8">
                    <input type="text" name="details[${idx}][name]" value="${escapeAttr(name)}" required
                           ...
                           class="w-full px-3 py-2 text-xs rounded-xl bg-white dark:bg-zinc-800 border border-slate-200 dark:border-zinc-700/60 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 placeholder-slate-400">
                </div>
