        ...
        <div class="bg-white dark:bg-zinc-900 rounded-3xl border border-slate-200/60 dark:border-zinc-800/60 shadow-sm overflow-hidden">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="date" name="date" value="{{ old('date', $defaultDate ?? date('Y-m-d')) }}" required
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <select name="category" required
                            ...
                            <option value="Development" @selected(old('category', 'Development') === 'Development')>Development</option>
                            <option value="Live" @selected(old('category') === 'Live')>Live</option>
                        </select>
                    </div>
